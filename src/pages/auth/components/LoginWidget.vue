    ...
    <CardContent class="p-0">
      <div class="flex flex-col md:flex-row">
        ...
        <div class="flex-1 p-8 space-y-5">
          <div>
            <TypographyH2 class="text-2xl font-bold text-foreground">Sign In</TypographyH2>
            <TypographyLead class="text-sm text-prof-blue font-medium mt-1">
              Welcome back to Biznest - sign in to continue
            </TypographyLead>
          </div>
          ...
          <form @submit.prevent="login" class="space-y-4">
            ...
            <div class="space-y-1">
              <div class="flex items-center justify-between">
                ...
                <span
                  class="text-xs text-prof-blue font-semibold cursor-pointer hover:underline"
        ...
        <!-- Right Side: Quick Sign In -->
        <div class="flex-1 p-8 space-y-5 flex flex-col justify-center">
          <div class="text-center">
            <TypographyH3 class="text-xl font-bold text-foreground">Quick Sign In</TypographyH3>
            <TypographyLead class="text-sm text-prof-blue font-medium mt-1">
