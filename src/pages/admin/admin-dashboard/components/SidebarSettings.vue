        ...
        <template #content>
            <div class="admin-layout">
                ...
                <main class="admin-main">
                    <TypographyH1 class="admin-dashboard-title">Settings</TypographyH1>
                    <TypographyP class="admin-dashboard-subtitle">Manage your application settings and preferences.</TypographyP>

                    <!-- Add your settings-specific content here -->
                    <div class="admin-table-section">
                    <TypographyP>Settings content goes here...</TypographyP>
                    </div>
                </main>
                </div>
            </div>
